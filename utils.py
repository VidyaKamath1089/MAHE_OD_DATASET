...
# Label map
voc_labels = ('airconditioner', 'air cooler', 'airplane', 'apple', 'aquatic bird', 'backpack', 'bag', 'ball', 'banana', 'bathtub', 
              'beans', 'bear', 'bed', 'bench', 'bicycle', 'bird', 'blender', 'boat', 'books', 'bottle',
              'bowl', 'broccoli', 'broom', 'bucket', 'buffalo', 'burger', 'bus', 'butterfly', 'cake', 'calculator',
              'camel', 'camera', 'capsicum', 'car', 'carrot', 'cat', 'cauliflower', 'cellphone', 'chair', 'chandelier', 
              'clock', 'cockroach', 'comb', 'couch', 'cow', 'crab', 'crocodile', 'cup', 'deer', 'desk', 
              'dining table', 'dog' , 'dolphin', 'donut', 'door', 'drangfly', 'elephant', 'eye glasses', 'fan', 'ferry', 
              'fire hydrant', 'fish', 'flowers', 'fork', 'fried egg', 'fries', 'frisbee', 'frog', 'frying pan', 'giraffe',
              'goat', 'gorilla', 'grapes', 'hair dryer', 'hammer', 'hat', 'head phones', 'helicopter', 'helmet', 'horse', 
              'hot dog', 'ice cream', 'ipod', 'kangaroo', 'kayak', 'keyboard', 'keys', 'kite', 'knife', 'ladder', 
              'lamp', 'laptop', 'lemon', 'lion', 'lobster', 'loofa', 'mango', 'mask', 'mattress', 'mice',
...
distinct_colors = ['#e6194b', '#3cb44b', '#ffe119', '#0082c8', '#f58231', '#911eb4', '#46f0f0', '#f032e6','#d2f53c', '#fabebe', 
		...
		'#008081', '#000081', '#aa6e29', '#fffac9', '#800001', '#aaffc4', '#80800a', '#ffd8b2', '#e6bef0', '#80808a', 
		'#e6194d', '#3cb44d', '#ffe111', '#0082c0', '#f58233', '#911eb6', '#46f0fb', '#f032e8','#d2f53e', '#fabeba', 
		'#008082', '#000082', '#aa6e20', '#fffaca', '#800002', '#aaffc5', '#80800b', '#ffd8b3', '#e6bef1', '#80808b', 
		'#e6194e', '#3cb44e', '#ffe112', '#0082c1', '#f58234', '#911eb7', '#46f0fc', '#f032e9','#d2f53f', '#fabebb', 
		'#008083', '#000083', '#aa6e2a', '#fffacb', '#80000a', '#aaffc6', '#80800c', '#ffd8b4', '#e6bef2', '#80808c', 
		'#e6194a', '#3cb44f', '#ffe113', '#0082c2', '#f58235', '#911eb8', '#46f0fd', '#f032e0','#d2f530', '#fabebc', 
		'#008084', '#000084', '#aa6e2b', '#fffacc', '#80000b', '#aaffc7', '#80800d', '#ffd8b5', '#e6bef3', '#80808d', 
		'#e6194f', '#3cb44a', '#ffe114', '#0082c3', '#f58236', '#911eb9', '#46f0fe', '#f032ea','#d2f531', '#fabebd', 
		'#008085', '#000085', '#aa6e2c', '#fffacd', '#80000c', '#aaffc8', '#80800e', '#ffd8b6', '#e6bef4', '#80808e', 
		'#e61941', '#3cb441', '#ffe115', '#0082c4', '#f58237', '#911eb0', '#46f0ff', '#f032eb','#d2f532', '#fabeb1', 
		'#008086', '#000086', '#aa6e2d', '#ffface', '#80000d', '#aaffc9', '#80800f', '#ffd8b7', '#e6bef5', '#80808f', 
		'#e61942', '#3cb442', '#ffe116', '#0082c5', '#f58238', '#911eb1', '#46f0f1', '#f032ec','#d2f533', '#fabeb2', 
		'#008087', '#000087', '#aa6e2e', '#fffacf', '#80000e', '#aaffca', '#808001', '#ffd8b8', '#e6bef6', '#808084', 
		'#e61943', '#3cb443', '#ffe117', '#0082c6', '#f58239', '#911eb2', '#46f0f2', '#f032ed','#d2f534', '#fabeb3', 
		'#008088', '#000088', '#aa6e2f', '#fffac0', '#80000f', '#aaffcb', '#808002', '#ffd8b9', '#e6bef7', '#808085', 
		'#FFFFFF']
